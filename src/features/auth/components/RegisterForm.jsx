    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4 font-sans">
            <div className="max-w-[900px] w-full bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col lg:flex-row min-h-[600px]">
                ...
                <div className="w-full lg:w-[40%] bg-gradient-to-br from-[#1e6091] to-[#164a75] p-6 lg:p-10 text-white relative flex flex-col justify-between">
                    ...
                    <div className="relative z-10 flex flex-col items-center text-center my-auto">
                        ...
                        <p className="text-blue-100 text-sm max-w-xs leading-relaxed mb-8">
                            Create an account to become a member, manage your profile, and participate in events.
                        </p>
                    ...
                    <div className="relative z-10 text-center lg:text-left mt-8">
                ...
                <div className="w-full lg:w-[60%] p-6 lg:p-10 flex flex-col justify-center bg-white relative">
                    <div className="max-w-md w-full mx-auto">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        type="text"
                                        className={`w-full pl-9 pr-4 py-2.5 rounded-lg border focus:ring-2 outline-none transition-all text-sm text-gray-700 placeholder-gray-400 bg-gray-50/50 focus:bg-white ${errors.fullName ? 'border-red-500 focus:ring-red-200' : 'border-gray-200 focus:border-[#1e6091] focus:ring-[#1e6091]/10'}`}
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className={`w-full pl-9 pr-10 py-2.5 rounded-lg border focus:ring-2 outline-none transition-all text-sm text-gray-700 placeholder-gray-400 bg-gray-50/50 focus:bg-white ${errors.confirmPassword ? 'border-red-500 focus:ring-red-200' : 'border-gray-200 focus:border-[#1e6091] focus:ring-[#1e6091]/10'}`}
                                            placeholder="••••••••"
                        ...
                        <div className="my-6 flex items-center justify-center space-x-4">
                            ...
                            <span className="text-gray-400 text-[10px] font-medium uppercase tracking-wider">Or register with</span>
                            <div className="h-px bg-gray-200 flex-1"></div>
                        </div>
