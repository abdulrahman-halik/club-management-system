...
export default function LoginForm({ onFormSubmit, loading, apiError }) {
  ...
  const onSubmit = (data) => {
    // data is already validated and parsed by Zod here
        ...
        <div className="w-full lg:w-[55%] p-6 lg:p-8 flex flex-col justify-center bg-white relative">
          <div className="max-w-sm w-full mx-auto">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
              ...
              <div className="flex items-center justify-between text-xs">
                ...
                <a
                  href="#"
                  className="font-semibold text-[#1e6091] hover:text-[#164a75]"
                >
                  Forgot Password?
                </a>
              </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-gray-500">
              ...
              <Link
                to="/register"
                className="font-semibold text-[#1e6091] hover:text-[#164a75] transition-colors"
              >
                Register now
              </Link>
            </p>
