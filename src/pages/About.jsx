        ...
        <div className="animate-in fade-in duration-500">
            ...
            <div className="bg-blue-900 text-white py-20">
                <div className="container mx-auto px-4 text-center">
                    <h1 className="text-4xl md:text-5xl font-extrabold mb-4">About Our Club</h1>
                ...
                <div className="grid md:grid-cols-2 gap-16 items-center mb-24">
                    ...
                    <div className="relative">
                        ...
                        <div className="absolute -bottom-8 -right-8 z-20 bg-white p-6 rounded-3xl shadow-xl flex flex-col items-center justify-center w-40 h-40 animate-bounce-slow border border-gray-100">
                            <div className="text-5xl font-black text-blue-600">14</div>
                            <div className="text-gray-500 text-xs font-bold uppercase tracking-wider text-center mt-1">Years of Service</div>
                        </div>
