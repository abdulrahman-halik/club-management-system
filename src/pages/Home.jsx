            ...
            <section className="relative bg-blue-900 text-white min-h-[500px] flex items-center justify-center overflow-hidden">
                ...
                <div className="container mx-auto text-center relative z-20 px-4">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-4">
                        <a href="#join" className="bg-white text-blue-900 px-8 py-3 rounded-full font-bold hover:bg-gray-100 transition shadow-lg inline-block">
                            Join the Club
                        </a>
                        <a href="#about" className="border-2 border-white px-8 py-3 rounded-full font-bold hover:bg-white/10 transition inline-block">
                            Learn More
                        </a>
                    </div>
                </div>
